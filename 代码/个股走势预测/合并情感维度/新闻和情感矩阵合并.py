...
news_file='F:\股票预测测试\stock-prediction-main\代码\个股走势预测\建立财务矩阵\合并\Zhongxing财务_删0_label0.01_forVisual_afterMerge.csv'
finance_file='F:\股票预测测试\stock-prediction-main\代码\个股走势预测\建立财务矩阵\TechNews_predict_merge_-1.csv'
