...
labels = json.loads(open('../新闻事件分类器/训练结果/trained_results_1624449205/labels.json').read())
...
with open('../新闻事件分类器/预测结果/predicted_results_1624449205/predictions_all_2020-07-15-3.csv','r',encoding='utf-8') as f :
